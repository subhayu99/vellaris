          ...
          <HowCard
            ...
            body={
              <>
                ...
                key. The key itself is then encrypted once for each recipient using their RSA
                public key.
              </>
            }
          />
  ...
  return (
    <svg viewBox="0 0 320 160" width="100%" height="100%" style={{ display: 'block' }}>
      ...
      <g transform="translate(232, 56)">
        <rect width="56" height="56" rx="10" fill="var(--accent-soft)" stroke="var(--accent-line)" />
        <g
  ...
  return (
    <svg viewBox="0 0 320 160" width="100%" height="100%" style={{ display: 'block' }}>
      ...
      <g transform="translate(196, 30)" opacity="0.6">
        ...
        <rect x="10" y="14" width="64" height="22" rx="4" fill="var(--bg-card)" stroke="var(--line)" />
        <circle cx="18" cy="25" r="2" fill="var(--ok)" />
        <line x1="28" y1="25" x2="62" y2="25" stroke="var(--line-strong)" />
        <rect x="10" y="42" width="64" height="22" rx="4" fill="var(--bg-card)" stroke="var(--line)" />
        <circle cx="18" cy="53" r="2" fill="var(--gold)" />
        <line x1="28" y1="53" x2="58" y2="53" stroke="var(--line-strong)" />
        <rect x="10" y="70" width="64" height="22" rx="4" fill="var(--bg-card)" stroke="var(--line)" />
  ...
  return (
    <svg viewBox="0 0 320 160" width="100%" height="100%" style={{ display: 'block' }}>
      ...
      <g transform="translate(160, 30)">
        ...
        <rect x="6" y="6" width="108" height="68" rx="3" fill="var(--bg-elev)" stroke="var(--line)" />
        ...
        {/* base */}
        <path d="M-8 80 L 128 80 L 124 86 L -4 86 Z" fill="var(--bg-elev-2)" stroke="var(--line-2)" />
      </g>
      {/* thread reverse */}
      <path
      ...
      <g transform="translate(120, 118)">
        ...
        <line x1="11" y1="6" x2="22" y2="6" stroke="var(--gold)" strokeWidth="1.4" strokeLinecap="round" />
        <line x1="18" y1="6" x2="18" y2="10" stroke="var(--gold)" strokeWidth="1.4" strokeLinecap="round" />
      </g>
    </svg>
  )
}
